...
if ( ! function_exists( 'noizzy_edge_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function noizzy_edge_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'noizzy_edge_blog_holder_classes', 'noizzy_edge_get_blog_holder_classes' );
}
