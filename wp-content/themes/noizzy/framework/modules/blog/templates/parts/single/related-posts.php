<?php
$show_related = noizzy_edge_options()->getOptionValue('blog_single_related_posts') == 'yes' ? true : false;
$related_post_number = noizzy_edge_sidebar_layout() === 'no-sidebar' ? 4 : 3;
$related_posts_options = array(
    'posts_per_page' => $related_post_number
);
$related_posts = noizzy_edge_get_blog_related_post_type(get_the_ID(), $related_posts_options);
        ...
        <div class="edge-related-posts-holder-inner">
            <?php if ( $related_posts && $related_posts->have_posts() ) : ?>
                <div class="edge-related-posts-title">
                    <h4><?php esc_html_e('Related Posts', 'noizzy' ); ?></h4>
                </div>
                        ...
                        <div class="edge-related-post">
                            <div class="edge-related-post-inner">
                                ...
                                <div class="edge-post-info">
                                    ...
                                    <?php noizzy_edge_get_module_template_part('templates/parts/post-info/author', 'blog', '', $params); ?>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
