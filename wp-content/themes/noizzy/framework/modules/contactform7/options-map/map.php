...
if ( ! function_exists('noizzy_edge_contact_form_7_options_map') ) {

	function noizzy_edge_contact_form_7_options_map() {
		
		noizzy_edge_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'noizzy' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = noizzy_edge_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'noizzy' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = noizzy_edge_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'noizzy' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'noizzy' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = noizzy_edge_add_admin_row(
			array(
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'noizzy' ),
			)
		);
		...
		$typography_text_row2 = noizzy_edge_add_admin_row(
			array(
		...
		$typography_text_row3 = noizzy_edge_add_admin_row(
			array(
		...
		$typography_label_group = noizzy_edge_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'noizzy' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'noizzy' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = noizzy_edge_add_admin_row(
			array(
		...
		$typography_label_row2 = noizzy_edge_add_admin_row(
			array(
		...
		$background_border_group = noizzy_edge_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'noizzy' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'noizzy' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = noizzy_edge_add_admin_row(
			array(
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'noizzy' )
			)
		);
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'noizzy' )
			)
		);
		
		$background_border_row2 = noizzy_edge_add_admin_row(
			array(
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'noizzy' ),
			)
		);
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'noizzy' )
			)
		);
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'noizzy' )
			)
		);
		
		$background_border_row3 = noizzy_edge_add_admin_row(
			array(
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'noizzy' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'noizzy' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = noizzy_edge_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'noizzy' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = noizzy_edge_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'noizzy' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'noizzy' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'noizzy' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'noizzy' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = noizzy_edge_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'noizzy' ),
				'description' => esc_html__( 'Setup form elements margin', 'noizzy' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = noizzy_edge_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'noizzy' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'noizzy' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = noizzy_edge_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'noizzy' ),
				'description' => esc_html__( 'Setup button text typography', 'noizzy' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = noizzy_edge_add_admin_row(
			array(
		...
		$button_typography_row2 = noizzy_edge_add_admin_row(
			array(
		...
		$button_background_border_group = noizzy_edge_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'noizzy' ),
				'description' => esc_html__( 'Setup button background and border style', 'noizzy' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = noizzy_edge_add_admin_row(
			array(
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'noizzy' )
			)
		);
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'noizzy' )
			)
		);
		
		$button_background_border_row2 = noizzy_edge_add_admin_row(
			array(
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'noizzy' )
			)
		);
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'noizzy' )
			)
		);
		
		$button_background_border_row3 = noizzy_edge_add_admin_row(
			array(
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'noizzy' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'noizzy' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = noizzy_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'noizzy')
		));

		//Text Typography

		$typography_text_group = noizzy_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'noizzy'),
			'description'	=> esc_html__('Setup typography for form elements text', 'noizzy'),
		...
		$typography_text_row1 = noizzy_edge_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = noizzy_edge_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = noizzy_edge_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = noizzy_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'noizzy'),
			'description'	=> esc_html__('Setup typography for form elements label', 'noizzy'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = noizzy_edge_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = noizzy_edge_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = noizzy_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'noizzy'),
			'description'	=> esc_html__('Setup form elements background and border style', 'noizzy'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = noizzy_edge_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = noizzy_edge_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = noizzy_edge_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = noizzy_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'noizzy'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = noizzy_edge_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = noizzy_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'noizzy'),
			'description'	=> esc_html__('Setup form elements margin', 'noizzy'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = noizzy_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = noizzy_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'noizzy'),
			'description'	=> esc_html__('Setup button text typography', 'noizzy'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = noizzy_edge_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = noizzy_edge_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = noizzy_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'noizzy'),
			'description'	=> esc_html__('Setup button background and border style', 'noizzy'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = noizzy_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = noizzy_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = noizzy_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = noizzy_edge_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'noizzy')
        ));
        ...
        $typography_label_row3 = noizzy_edge_add_admin_row(array(
        ...
        $button_typography_row3 = noizzy_edge_add_admin_row(array(
	...
	add_action( 'noizzy_edge_options_map', 'noizzy_edge_contact_form_7_options_map', 20);
}