...
class HeaderStandard extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters['menu_area_position_class'] = ! empty( $menu_area_position ) ? 'edge-menu-' . $menu_area_position : 'edge-menu-right';
		
		$parameters = apply_filters( 'noizzy_edge_header_standard_parameters', $parameters );
