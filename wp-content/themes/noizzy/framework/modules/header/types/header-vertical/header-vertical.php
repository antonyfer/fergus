...
class HeaderVertical extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		$parameters['holder_class'] = noizzy_edge_vertical_header_holder_class();
		
		$parameters = apply_filters( 'noizzy_edge_header_vertical_parameters', $parameters );
	...
	public function getPerPageJSVariables( $perPageVars ) {
        ...
        $perPageVars['edgeHeaderVerticalWidth'] = 312;
