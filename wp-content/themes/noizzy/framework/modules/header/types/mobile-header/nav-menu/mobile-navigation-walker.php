...
if (!class_exists('NoizzyEdgeMobileNavigationWalker')) {
	class NoizzyEdgeMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="edge-sub-arrow fa fa-angle-double-right"></i><i class="fa fa-angle-double-down"></i></span>';
				}
			}
