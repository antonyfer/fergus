...
if ( ! function_exists( 'noizzy_edge_get_hide_dep_for_header_main_menu_options' ) ) {
	function noizzy_edge_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'noizzy_edge_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'noizzy_edge_header_main_navigation_options_map' ) ) {
	function noizzy_edge_header_main_navigation_options_map() {
		$hide_dep_options = noizzy_edge_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = noizzy_edge_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'noizzy' ),
		...
		noizzy_edge_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'noizzy' )
			)
		);
		...
		$drop_down_group = noizzy_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'noizzy' )
			)
		);
		
		$drop_down_row1 = noizzy_edge_add_admin_row(
			array(
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'type'          => 'imagesimple',
				'name'          => 'dropdown_background_pattern',
				'default_value' => '',
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'noizzy' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'noizzy' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'noizzy' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'noizzy' )
				)
			)
		);
		...
		$first_level_group = noizzy_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'noizzy' )
			)
		);
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'noizzy' ),
			)
		);
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'noizzy' ),
			)
		);
		
		$first_level_row4 = noizzy_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'noizzy' ),
			)
		);
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'noizzy' ),
			)
		);
		
		$first_level_row5 = noizzy_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = noizzy_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = noizzy_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'noizzy' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		noizzy_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'noizzy' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = noizzy_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'noizzy' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'noizzy' )
			)
		);
		...
		$second_level_wide_group = noizzy_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'noizzy' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'noizzy' )
			)
		);
		
		$second_level_wide_row1 = noizzy_edge_add_admin_row(
			array(
		...
		$second_level_wide_row2 = noizzy_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = noizzy_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = noizzy_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'noizzy' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'noizzy' )
			)
		);
		...
		$third_level_row3 = noizzy_edge_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = noizzy_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'noizzy' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'noizzy' )
			)
		);
		
		$third_level_wide_row1 = noizzy_edge_add_admin_row(
			array(
		...
		$third_level_wide_row2 = noizzy_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = noizzy_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'noizzy_edge_header_main_navigation_options_map', 'noizzy_edge_header_main_navigation_options_map', 10, 1 );
}