(function () {
    ...
    tinymce.PluginManager.add('edge_shortcodes', function (ed, url) {
        ed.addButton('edge_shortcodes', {
            title: window.edgeSCLabel,
            image: window.edgeSCIcon,
            icon: false,
            type: 'menubutton',
            menu: [
                {
                ...
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[edge_dropcaps type="' + e.data.type + '" color="' + e.data.color + '" background_color="' + e.data.background_color + '"]' + e.data.letter + '[/edge_dropcaps]');
                            }
                        });
                    }
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[edge_highlight background_color="' + e.data.background_color + '" color="' + e.data.color + '"]' + e.data.text + '[/edge_highlight]');
                            }
                        });
                    }
                },
                        ...
                        ed.windowManager.open({
                            ...
                            body: [
                                ...
                                },
                                {
                                    ...
                                    label: 'Size',
                                    'values': [
                                        {text: 'Tiny', value: 'edge-icon-tiny'},
                                        {text: 'Small', value: 'edge-icon-small'},
                                        {text: 'Medium', value: 'edge-icon-medium'},
                                        {text: 'Large', value: 'edge-icon-large'},
                                        {text: 'Very Large', value: 'edge-icon-huge'}
                                    ]
                                },
                                {
                                    type: 'textbox',
                ...
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[edge_separator class_name="' + e.data.class_name + '" type="' + e.data.type + '" position="' + e.data.position + '" color="' + e.data.color + '" border_style="' + e.data.border_style + '" width="' + e.data.width + '" thickness="' + e.data.thickness + '" top_margin="' + e.data.top_margin + '" bottom_margin="' + e.data.bottom_margin + '"]');
                            }
                        });
                    }
                }
