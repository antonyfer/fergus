...
class NoizzyEdgeLinearIcons implements iNoizzyEdgeIconCollection {
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="edge-icon-linear-icons lnr ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
