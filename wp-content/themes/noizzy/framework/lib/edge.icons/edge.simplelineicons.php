...
class NoizzyEdgeSimpleLineIcons implements iNoizzyEdgeIconCollection {
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="edge-icon-simple-line-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString .
            '></i>';
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'noizzy'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'noizzy'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'noizzy'),
            'icon-social-facebook'    => esc_html__('Facebook', 'noizzy'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'noizzy'),
            'icon-social-github'      => esc_html__('Github', 'noizzy'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'noizzy'),
            'icon-social-instagram'   => esc_html__('Instagram', 'noizzy'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'noizzy'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'noizzy'),
            'icon-social-reddit'      => esc_html__('Reddit', 'noizzy'),
            'icon-social-skype'       => esc_html__('Skype', 'noizzy'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'noizzy'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'noizzy'),
            'icon-social-spotify'     => esc_html__('Spotify', 'noizzy'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'noizzy'),
            'icon-social-twitter'     => esc_html__('Twitter', 'noizzy'),
            'icon-social-youtube'     => esc_html__('Youtube', 'noizzy')
        );
    }
