...
class NoizzyEdgeIconsFontElegant implements iNoizzyEdgeIconCollection {
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="edge-icon-font-elegant ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
