<div class="edge-audio-player-wrapper <?php echo esc_attr($player_classes) ?>">
	...
	<div id= "edge-player-container-<?php echo esc_attr($player_id); ?>" class="edge-audio-player-holder edge-audio-player-with-images" data-album-id="<?php echo esc_attr($album); ?>">
		<div class="edge-audio-player-tracks-images-holder">
			<div class="jp-audio player-box">
				<div class="jp-type-playlist">
					<div class="jp-playlist swiper-container">
						<ul class="tracks-list swiper-wrapper">
		...
		<?php endif; ?>
		<div class="edge-audio-player-main-holder">
			...
			<div class="edge-audio-player-volume-holder">
				<div class="jp-volume-controls">
					<a class="jp-mute" role="button" tabindex="0"><i class="edge-audio-volume-high icon_volume-high" aria-hidden="true"></i><i class="edge-audio-volume-mute icon_vol-mute" aria-hidden="true"></i></a>
