<?php
namespace NoizzyCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'edge_full_screen_sections_item';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Full Screen Sections Item', 'noizzy-core' ),
					'base'            => $this->base,
					'as_child'        => array( 'only' => 'edge_full_screen_sections' ),
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'noizzy-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'noizzy-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'noizzy-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'noizzy-core' )   => 'cover',
								esc_html__( 'Contain', 'noizzy-core' ) => 'contain',
								esc_html__( 'Inherit', 'noizzy-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'noizzy-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'noizzy-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'noizzy-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'noizzy-core' ),
							'value'       => array(
								esc_html__( 'Default', 'noizzy-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'noizzy-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'noizzy-core' ),
							'value'       => array(
								esc_html__( 'Default', 'noizzy-core' ) => '',
							...
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'noizzy-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'noizzy-core'),
							'group'       => esc_html__('Responsiveness', 'noizzy-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'noizzy-core'),
							'group'       => esc_html__('Responsiveness', 'noizzy-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'noizzy-core'),
							'group'       => esc_html__('Responsiveness', 'noizzy-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'noizzy-core'),
							'group'       => esc_html__('Responsiveness', 'noizzy-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$rand_class = 'edge-fss-custom-' . mt_rand(100000,1000000);
		...
		$html = noizzy_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['vertical_alignment'] ) ? 'edge-fss-item-va-' . $params['vertical_alignment'] : '';
		$holderClasses[] = ! empty( $params['horizontal_alignment'] ) ? 'edge-fss-item-ha-' . $params['horizontal_alignment'] : '';
		$holderClasses[] = ! empty( $params['link'] ) ? 'edge-fss-item-has-link' : '';
		$holderClasses[] = ! empty( $params['header_skin'] ) ? 'edge-fss-item-has-style' : '';
