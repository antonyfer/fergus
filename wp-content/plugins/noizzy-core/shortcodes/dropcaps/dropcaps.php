<?php
namespace NoizzyCore\CPT\Shortcodes\Dropcaps;
...
class Dropcaps implements Lib\ShortcodeInterface {
	...
	public function render( $atts, $content = null ) {
		...
		$html = noizzy_core_get_shortcode_module_template_part( 'templates/dropcaps-template', 'dropcaps', '', $params );
	...
	private function getDropcapsClass( $params ) {
		return ! empty( $params['type'] ) ? 'edge-' . $params['type'] : '';
	}
}