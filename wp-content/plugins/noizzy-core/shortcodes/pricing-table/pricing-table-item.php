<?php
namespace NoizzyCore\CPT\Shortcodes\PricingTable;
...
class PricingTableItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'edge_pricing_table_item';
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Content Background Color', 'noizzy-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
							'heading'     => esc_html__( 'Title', 'noizzy-core' ),
							'value'       => esc_html__( 'Basic Plan', 'noizzy-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Title Bottom Border Color', 'noizzy-core' ),
							'dependency' => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'price',
							'heading'    => esc_html__( 'Price', 'noizzy-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'price_color',
							'heading'    => esc_html__( 'Price Color', 'noizzy-core' ),
							'dependency' => array( 'element' => 'price', 'not_empty' => true )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'currency',
							'heading'     => esc_html__( 'Currency', 'noizzy-core' ),
							'description' => esc_html__( 'Default mark is $', 'noizzy-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'currency_color',
							'heading'    => esc_html__( 'Currency Color', 'noizzy-core' ),
							'dependency' => array( 'element' => 'currency', 'not_empty' => true )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'price_period',
							'heading'     => esc_html__( 'Price Period', 'noizzy-core' ),
							'description' => esc_html__( 'Default label is monthly', 'noizzy-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'price_period_color',
							'heading'    => esc_html__( 'Price Period Color', 'noizzy-core' ),
						...
						array(
							...
							'value'       => esc_html__( 'BUY NOW', 'noizzy-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = noizzy_core_get_shortcode_module_template_part( 'templates/pricing-table-template', 'pricing-table', '', $params );
