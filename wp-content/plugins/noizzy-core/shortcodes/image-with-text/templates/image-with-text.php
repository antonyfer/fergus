<div class="edge-image-with-text-holder <?php echo esc_attr($holder_classes); ?>">
    ...
    <div class="edge-iwt-text-holder">
        ...
        <?php } ?>
        <?php if(!empty($title)) { ?>
            <<?php echo esc_attr($title_tag); ?> class="edge-iwt-title" <?php echo noizzy_edge_get_inline_style($title_styles); ?>><?php echo esc_html($title); ?></<?php echo esc_attr($title_tag); ?>>
        <?php } ?>
        <?php if ($image_behavior === 'custom-link' && !empty($custom_link)) { ?>
            </a>
        <?php } ?>
		<?php if(!empty($text)) { ?>
            <p class="edge-iwt-text" <?php echo noizzy_edge_get_inline_style($text_styles); ?>><?php echo esc_html($text); ?></p>
        <?php } ?>
    </div>
</div>