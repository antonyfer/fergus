<?php
namespace NoizzyCore\CPT\Shortcodes\ImageWithText;
...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image With Text', 'noizzy-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'info_text_position',
							'heading'    => esc_html__( 'Info Text Position', 'noizzy-core' ),
							'value'      => array(
								esc_html__( 'Info Below Image', 'noizzy-core' ) => '',
								esc_html__( 'Info Over Image', 'noizzy-core' )  => 'info_over_image'
							)
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = noizzy_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['info_text_position'] ) ? 'edge-info-text-over' : '';
