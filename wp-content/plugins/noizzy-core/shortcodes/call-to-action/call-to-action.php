<?php
namespace NoizzyCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'noizzy-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'layout',
							'heading'     => esc_html__( 'Layout', 'noizzy-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'noizzy-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'noizzy-core' ),
							'value'      => array(
								esc_html__( '80/20', 'noizzy-core' ) => '80',
								esc_html__( '75/25', 'noizzy-core' ) => '75',
								esc_html__( '66/33', 'noizzy-core' ) => '66',
								esc_html__( '50/50', 'noizzy-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Text', 'noizzy-core' ),
							'value'       => esc_html__( 'Button Text', 'noizzy-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'button_top_margin',
							'heading'    => esc_html__( 'Button Top Margin (px)', 'noizzy-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'noizzy-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_type',
							'heading'     => esc_html__( 'Button Type', 'noizzy-core' ),
							'value'       => array(
								esc_html__( 'Solid', 'noizzy-core' )   => 'solid',
								esc_html__( 'Outline', 'noizzy-core' ) => 'outline'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Button Style', 'noizzy-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'noizzy-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link', 'noizzy-core' ),
							'group'      => esc_html__( 'Button Style', 'noizzy-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'button_target',
							'heading'    => esc_html__( 'Button Link Target', 'noizzy-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'noizzy-core' ),
							'group'      => esc_html__( 'Button Style', 'noizzy-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'noizzy-core' ),
							'group'      => esc_html__( 'Button Style', 'noizzy-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_background_color',
							'heading'    => esc_html__( 'Button Background Color', 'noizzy-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'noizzy-core' ),
							'group'      => esc_html__( 'Button Style', 'noizzy-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'noizzy-core' ),
							'group'      => esc_html__( 'Button Style', 'noizzy-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'noizzy-core' ),
							'group'      => esc_html__( 'Button Style', 'noizzy-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'noizzy-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'noizzy-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = noizzy_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['layout'] ) ? 'edge-' . $params['layout'] . '-layout' : '';
		$holderClasses[] = $params['content_in_grid'] === 'yes' && $params['layout'] === 'normal' ? 'edge-content-in-grid' : '';
	...
	private function getInnerClasses( $params ) {
		...
		$innerClasses[] = $params['layout'] === 'normal' && $params['content_in_grid'] === 'yes' ? 'edge-grid' : '';
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . noizzy_edge_filter_px( $params['button_top_margin'] ) . 'px';
		}
	...
	private function getButtonParameters( $params ) {
        ...
        $button_params_array['fa_icon'] = 'fa fa-angle-double-right';
