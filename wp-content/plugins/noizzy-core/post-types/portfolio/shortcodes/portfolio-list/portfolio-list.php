...
namespace NoizzyCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'noizzy-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'noizzy-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'noizzy-core' ) => 'gallery',
						...
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'noizzy-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'noizzy-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'noizzy-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'noizzy-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio list. Enter -1 to show all.', 'noizzy-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
							...
							'description' => esc_html__( 'Set image proportions for your portfolio list.', 'noizzy-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_fixed_proportions',
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'noizzy-core' ),
							'value'       => array_flip( noizzy_edge_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'noizzy-core' ),
						...
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'noizzy-core' ),
							'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'noizzy-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'selected_projects',
							'heading'     => esc_html__( 'Show Only Projects with Listed IDs', 'noizzy-core' ),
							'settings'    => array(
								'multiple'      => true,
								'sortable'      => true,
								'unique_values' => true
						...
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'noizzy-core' ),
							'description' => esc_html__( 'Enter one tag slug (leave empty for showing all tags)', 'noizzy-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'noizzy-core' ),
							'value'      => array(
								esc_html__( 'Standard - Shader', 'noizzy-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'noizzy-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Overlay Center', 'noizzy-core' )          => 'gallery-overlay',
								esc_html__( 'Gallery - Overlay Top', 'noizzy-core' )          => 'gallery-overlay-top',
								esc_html__( 'Gallery - Slide From Image Bottom', 'noizzy-core' ) => 'gallery-slide-from-image-bottom'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'noizzy-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'noizzy-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'noizzy-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Item Skin', 'noizzy-core' ),
							'value'      => array(
								esc_html__( 'Light', 'noizzy-core' ) => 'light',
								esc_html__( 'Dark', 'noizzy-core' ) => 'dark'
							),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'gallery-slide-from-image-bottom') ),
							'group'      => esc_html__( 'Content Layout', 'noizzy-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'enable_title',
							'heading'    => esc_html__( 'Enable Title', 'noizzy-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'noizzy-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'noizzy-core' ),
							'value'      => array_flip( noizzy_edge_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'noizzy-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'noizzy-core' ),
							'value'      => array_flip( noizzy_edge_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'noizzy-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'noizzy-core' ),
							'value'      => array_flip( noizzy_edge_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'noizzy-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'noizzy-core' ),
							'description' => esc_html__( 'Number of characters', 'noizzy-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'noizzy-core' ),
							'value'      => array(
								esc_html__( 'None', 'noizzy-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'noizzy-core' )        => 'standard',
								esc_html__( 'Load More', 'noizzy-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'noizzy-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'noizzy-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'noizzy-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'noizzy-core' ),
							'value'      => array_flip( noizzy_edge_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'noizzy-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'noizzy-core' ),
							'value'      => array(
								esc_html__( 'Name', 'noizzy-core' )  => 'name',
								esc_html__( 'Count', 'noizzy-core' ) => 'count',
								esc_html__( 'Id', 'noizzy-core' )    => 'id',
								esc_html__( 'Slug', 'noizzy-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'noizzy-core' ),
							'value'      => array_flip( noizzy_edge_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'noizzy-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'noizzy-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'noizzy-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'noizzy-core' ),
							'value'       => array_flip( noizzy_edge_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'noizzy-core' ),
							'group'       => esc_html__( 'Additional Features', 'noizzy-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$additional_params['holder_data']          = noizzy_edge_get_holder_data_for_cpt( $params, $additional_params );
		...
		$html = noizzy_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getHolderClasses( $params, $args ) {
		...
		$classes[] = ! empty( $params['type'] ) ? 'edge-pl-' . $params['type'] : 'edge-pl-' . $args['type'];
		...
		$classes[] = ! empty( $params['item_style'] ) ? 'edge-pl-' . $params['item_style'] : '';
		$classes[] = $params['enable_fixed_proportions'] === 'yes' ? 'edge-masonry-images-fixed' : '';
		$classes[] = $params['enable_image_shadow'] === 'yes' ? 'edge-pl-has-shadow' : '';
		$classes[] = $params['enable_title'] === 'no' && $params['enable_category'] === 'no' && $params['enable_excerpt'] === 'no' ? 'edge-pl-no-content' : '';
		$classes[] = ! empty( $params['pagination_type'] ) ? 'edge-pl-pag-' . $params['pagination_type'] : '';
		$classes[] = $params['filter'] === 'yes' ? 'edge-pl-has-filter' : '';
		$classes[] = $params['enable_article_animation'] === 'yes' ? 'edge-pl-has-animation' : '';
		$classes[] = ! empty( $params['navigation_skin'] ) ? 'edge-nav-' . $params['navigation_skin'] . '-skin' : '';
		$classes[] = ! empty( $params['pagination_skin'] ) ? 'edge-pag-' . $params['pagination_skin'] . '-skin' : '';
		$classes[] = ! empty( $params['pagination_position'] ) ? 'edge-pag-' . $params['pagination_position'] : '';
	...
	public function getHolderInnerClasses( $params ) {
		...
		$classes[] = $params['portfolio_slider_on'] === 'yes' ? 'edge-owl-slider edge-pl-is-slider' : '';
		$classes[] = $params['portfolio_slider_on'] === 'yes' ? $params['additional_class'] : '';

		return implode( ' ', $classes );
	}

	public function getArticleHolderStyles( $params ) { 
		$styles = array();

		if(get_post_meta( get_the_ID(), "edge_portfolio_initial_background_color_meta", true ) !== ''){
			$styles[] =  'background-color: ' . get_post_meta( get_the_ID(), "edge_portfolio_initial_background_color_meta", true );
		}
	...
	public function getArticleClasses( $params ) {
		...
		$classes[] = ! empty( $masonry_size ) && $type === 'masonry' ? 'edge-masonry-size-' . esc_attr( $masonry_size ) : '';
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( noizzy_edge_string_ends_with( $margin_top, '%' ) || noizzy_edge_string_ends_with( $margin_top, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin_top;
			} else {
				$styles[] = 'margin-top: ' . noizzy_edge_px( $margin_top ) . 'px';
			}
		}
		
		if ( ! empty( $margin_bottom ) ) {
			if ( noizzy_edge_string_ends_with( $margin_bottom, '%' ) || noizzy_edge_string_ends_with( $margin_bottom, 'px' ) ) {
				$styles[] = 'margin-bottom: ' . $margin_bottom;
			} else {
				$styles[] = 'margin-bottom: ' . noizzy_edge_px( $margin_bottom ) . 'px';
			}
		}
	...
	public function getLoadMoreStyles( $params ) {
		...
		if ( ! empty( $params['load_more_top_margin'] ) ) {
			...
			if ( noizzy_edge_string_ends_with( $margin, '%' ) || noizzy_edge_string_ends_with( $margin, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin;
			} else {
				$styles[] = 'margin-top: ' . noizzy_edge_px( $margin ) . 'px';
			}
		}
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( noizzy_edge_string_ends_with( $margin, '%' ) || noizzy_edge_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . noizzy_edge_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'noizzy_edge_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'noizzy_edge_portfolio_external_link_target', $portfolio_link_target );
	}
	...
	public function portfolioCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['portfolio_category_title'] ) > 0 ) ? esc_html__( 'Category', 'noizzy-core' ) . ': ' . $value['portfolio_category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_category ) ) {
				...
				if ( ! empty( $portfolio_category_title ) ) {
					$portfolio_category_title_display = esc_html__( 'Category', 'noizzy-core' ) . ': ' . $portfolio_category_title;
				}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $portfolio ) ) {
				...
				if ( ! empty( $portfolio_title ) ) {
					$portfolio_title_display = ' - ' . esc_html__( 'Title', 'noizzy-core' ) . ': ' . $portfolio_title;
				}
				
				$portfolio_id_display = esc_html__( 'Id', 'noizzy-core' ) . ': ' . $portfolio_id;
	...
	public function portfolioTagAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['slug'];
				$data['label'] = ( ( strlen( $value['portfolio_tag_title'] ) > 0 ) ? esc_html__( 'Tag', 'noizzy-core' ) . ': ' . $value['portfolio_tag_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_tag ) ) {
				...
				if ( ! empty( $portfolio_tag_title ) ) {
					$portfolio_tag_title_display = esc_html__( 'Tag', 'noizzy-core' ) . ': ' . $portfolio_tag_title;
				}
