<?php
if ( ! function_exists( 'noizzy_edge_init_google_fonts_array' ) ) {
    function noizzy_edge_init_google_fonts_array() {
        ...
        $noizzy_edge_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'noizzy_edge_init_google_fonts_array');
}