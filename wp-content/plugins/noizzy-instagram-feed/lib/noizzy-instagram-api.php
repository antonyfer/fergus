...
include 'noizzy-instagram-helper.php';

/**
 * Class NoizzyInstagramApi
 */
class NoizzyInstagramApi {
    ...
    const INSTAGRAM_CODE = 'noizzy_instagram_code';
    const INSTAGRAM_USER_ID = 'noizzy_instagram_user_id';
    const INSTAGRAM_TOKEN = 'noizzy_instagram_access_token';
    const INSTAGRAM_TOKEN_LONG_LIVED = 'noizzy_instagram_access_token_long_lived';
    const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'noizzy_instagram_access_token_long_lived_time';

    const FACEBOOK_CODE = 'noizzy_facebook_code';
    const FACEBOOK_TOKEN = 'noizzy_facebook_access_token';

    const CONNECTION_TYPE = 'noizzy_connection_type';
    ...
    public function __construct() {
        ...
        $this->helper = new NoizzyInstagramHelper();
    }
     ...
     *
     * @see NoizzyInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see NoizzyInstagramApi::instagramExchangeCodeForToken()
     */
    ...
    public function getPostById($link = '') {
        $returnObject = new stdClass();

        $response = wp_remote_get('https://graph.facebook.com/v9.0/instagram_oembed?url=' . $link . '&access_token=' . $this->facebookClientID . '|' .  'd72aec245d0330729966b3996f96c2a0');
        $response = json_decode(wp_remote_retrieve_body($response) , true);

        if(is_wp_error($response)) {
            $returnObject->status = 'error';
            $returnObject->message = esc_html__('Can\'t connect with Instagram', 'edge-instagram-feed');
