...
/**
 * Class NoizzyInstagramHelper
 */
class NoizzyInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines noizzy_instagram_image_atts filter
     *
    ...
    public function getImageHTML( $image ) {
        ...
        $imageAtts = apply_filters( 'noizzy_instagram_image_atts',
            array(
